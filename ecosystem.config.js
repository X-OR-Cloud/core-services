module.exports = {
  apps: [
    ...
    },
    {
      ...
      error_file: './logs/aiwm-nws-00-error.log',
      out_file: './logs/aiwm-nws-00-out.log',
      merge_logs: true,
    ...
    },
    {
      ...
      // Logging
      error_file: './logs/cbm-emb-00-error.log',
      out_file: './logs/cbm-emb-00-out.log',
      merge_logs: true,
      ...
      // Advanced settings
      kill_timeout: 15000,  // Allow graceful lock release + indexing completion
      wait_ready: false,  // Worker doesn't listen on a port
      listen_timeout: 10000,
    },
    {
      name: 'core.cbm.api01',
    ...
    // ========== VSM (Voice Service Management) ==========
    {
      ...
      error_file: './logs/vsm-api-00-error.log',
      out_file: './logs/vsm-api-00-out.log',
      merge_logs: true,
    ...
    },
    {
      ...
      error_file: './logs/vsm-api-01-error.log',
      out_file: './logs/vsm-api-01-out.log',
      merge_logs: true,
    ...
    },
    {
      ...
      env: {
        ...
        AMI_HOST: '127.0.0.1',
        AMI_PORT: '5038',
        // NODE_ID, AMI_USERNAME, AMI_SECRET loaded from .env after node provisioning
      },

      env_file: '.env',

      error_file: './logs/vsm-ami-00-error.log',
      out_file: './logs/vsm-ami-00-out.log',
      merge_logs: true,
