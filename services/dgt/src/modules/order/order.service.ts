...
export class OrderService extends BaseService<Order> {
  ...
  async findAll(options: FindManyOptions, context: RequestContext): Promise<FindManyResult<Order>> {
  ...
  async findById(id: any, context: RequestContext): Promise<Partial<Order>> {
