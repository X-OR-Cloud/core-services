...
export class PositionService extends BaseService<Position> {
  ...
  async findAll(options: FindManyOptions, context: RequestContext): Promise<FindManyResult<Position>> {
  ...
  async findById(id: any, context: RequestContext): Promise<Partial<Position>> {
