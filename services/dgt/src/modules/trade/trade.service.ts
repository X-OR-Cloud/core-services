...
export class TradeService extends BaseService<Trade> {
  ...
  async findAll(options: FindManyOptions, context: RequestContext): Promise<FindManyResult<Trade>> {
  ...
  async findById(id: any, context: RequestContext): Promise<Partial<Trade>> {
