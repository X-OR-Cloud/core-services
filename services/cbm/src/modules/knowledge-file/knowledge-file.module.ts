...
import { KnowledgeFileController, KnowledgeFileTestController } from './knowledge-file.controller';
...
@Module({
  ...
  controllers: [KnowledgeFileTestController, KnowledgeFileController],
