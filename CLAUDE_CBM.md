...
**Trước khi thực hiện bất kỳ tool call nào**, dùng `mcp__Chat__SendMessage` để gửi thông báo cho user biết đang làm gì.
...
- Ảnh hưởng cách làm việc → update Instruction (file `CLAUDE_CBM.md`)
